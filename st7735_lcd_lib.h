#ifndef _ST7735_LCD_LIB_
#define _ST7735_LCD_LIB_

#include "fonts.h"
#include <stdbool.h>

#define ST7735_PIN_DIN 28
#define ST7735_PIN_CLK 29
#define ST7735_PIN_CS 27
#define ST7735_PIN_DC 26
#define ST7735_PIN_RESET 22
#define ST7735_PIN_BL 24
#define ST7735_SERIAL_CLK_DIV 2.f
...
// (255,255,255) to 0xffff
#define ST7735_RGB888to565(r, g, b) (((r & 0xF8) << 8) | ((g & 0xFC) << 3) | ((b & 0xF8) >> 3))
// (31,63,31) to 0xffff
#define ST7735_COLOR565(r, g, b)  ((((r) << 11) | ((g) << 5) | (b))) 
